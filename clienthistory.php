...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    try {
        ...
        $stmt = $pdo->prepare("
            SELECT c.call_id, cs.name AS support_name, c.call_status, c.call_start_time, c.call_end_time, f.rating, f.feedback
            FROM calls c
            LEFT JOIN customer_support cs ON c.support_id COLLATE utf8mb4_unicode_ci = cs.uuid COLLATE utf8mb4_unicode_ci
